...
const footerLinks = {
  produk: [
    ...
    { label: "Harga", href: "/produk#harga" },
    { label: "Update", href: "/produk#update" },
  ],
  perusahaan: [
    { label: "Tentang Kami", href: "/perusahaan" },
    { label: "Karir", href: "/perusahaan#karir" },
    { label: "Kontak", href: "/perusahaan#kontak" },
  ],
  bantuan: [
    { label: "Pusat Bantuan", href: "/bantuan" },
    { label: "Panduan", href: "/bantuan#panduan" },
        ...
        <div className="pt-8 border-t border-[#FFEDE8]/10">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-sm text-[#FFEDE8]/60">
              © {currentYear} DapurHPP. Semua hak dilindungi.
            </p>
